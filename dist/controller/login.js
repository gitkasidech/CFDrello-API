...
var loginCallback = 'http://' + _configs.webs.host + ':' + _configs.server.port + '/callback';
var oauth_secrets = {};
                                                        ...
                                                        return _regenerator2.default.wrap(function _callee2$(_context2) {
                                                            while (1) {
                                                                switch (_context2.prev = _context2.next) {
                                                                    case 0:
                                                                        if (error) res.redirect('http://' + _configs.webs.host + ':' + _configs.webs.port);
                                                                    ...
                                                                    case 6:
                                                                        ...
                                                                        res.redirect('http://' + _configs.webs.host + ':' + _configs.webs.port + '/gettoken/' + accessToken + '/' + dataJ.id);
